  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
        ...
        <Section title="Your recordings and content">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return <section><h2 className="mb-3 text-lg font-semibold" style={{ color: 'var(--color-text-primary)' }}>{title}</h2><div>{children}</div></section>;
}
